...
class Profile extends MY_Controller {
    ...
    public function update($id) //membutuhkan parameter $id tuk memilih produk yg akan di edit
    {
        $data['content'] = $this->profile->where('id', $id)->first(); //first tuk mendptkan 1 baris data
