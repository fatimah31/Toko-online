                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            <?php $this->load->view('layouts/_alert', ['status' => $order->status]); ?>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <table class="table">
                         ...
                         <?php foreach($order_detail as $row) : ?>
                             <tr>
                                 <td>
                                     <p><img src="<?= $row->image ? base_url("images/product/$row->image") : base_url("images/product/default.png") ?>" alt="" height="200"><strong><?= $row->title ?></strong></p>
                                 </td>
