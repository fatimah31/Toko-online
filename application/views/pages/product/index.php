                    ...
                    <table class="table">
                        ...
                        <?php $no = 0; foreach ($content as $row): $no++; ?>
                            <tr>
                                ...
                                <td>
                                    <p>
                                        <img src="<?= $row->image ? base_url("images/product/$row->image") : base_url("images/product/default.png") ?>" height="50" alt="">
                                        <?= $row->product_title ?>
                                    </p>
                                </td>
                                <td>
                                ...
                                <td>
                                <?= form_open(base_url("/product/delete/$row->id"), ['method' => 'POST']) ?> <!-- form milik form helper -->
