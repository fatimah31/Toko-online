       ...
       <div class="col-md-12">
           <div class="card mb-3">
                       ...
                       <?php foreach($content as $row) : ?>
                           <tr>
                               ...
                               <td>
                                   ...
                                   <input type="hidden" name="id" value="<?= $row->id ?>">
                                       <button class="btn btn-danger" type="submit" onclick="return confirm('Apakah yakin mau menghapusnya ?')"><i class="fas fa-trash-alt"></i></button>
                                   </form>
                               </td>
                           </tr>
                        <?php endforeach ?>
               ...
               <div class="card-footer">
                   ...
                   <a href="<?= base_url('/') ?>" class="btn btn-warning text-white"><i class="fas fa-angle-left"> Kembali Belanja</i></a>
               </div>
           </div>
       </div>
    </div>
